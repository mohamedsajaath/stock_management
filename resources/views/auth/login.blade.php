                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-4 input-group"><span class="input-group-text">
                                        ...
                                        <input id="password"  type="password"
                                            name="password" required autocomplete="current-password"  class="form-control" placeholder="Password">
                                            <x-input-error :messages="$errors->get('password')" class="mt-2" />
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <button class="px-4 btn btn-primary" type="submit">    {{ __('Log in') }}</button>
                                        </div>
